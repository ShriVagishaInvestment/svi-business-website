			...
			<div className='flex flex-col w-full h-full text-center lg:flex-row lg:text-left lg:items-center lg:justify-between max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
				...
				<div className='flex items-center justify-center flex-1 py-12 lg:py-0 lg:pr-8'>
					<div className='max-w-xl w-full'>
						<h1 className='text-3xl font-black text-brand-white md:text-4xl lg:text-5xl xl:text-6xl leading-tight'>
							{HERO_TITLE}
						</h1>
						<p className='mt-4 text-base font-light text-brand-white opacity-90 md:text-lg lg:text-xl leading-relaxed'>
							{HERO_SUBTITLE}
						</p>
